...
def run(container_name, confirmed):
    ...
    if container_name in protected:
        return {"error": f"'{container_name}' is a protected resource and cannot be started via this tool."}
    ...
    if not confirmed:
        ...
        return {
            ...
            "message": f"This will START the '{container_name}' container. Tell the user to type exactly /confirm within 2 minutes to proceed."
        }
